...
export class CreateCalendarsAndEvents1543884172010 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "events" ("id" SERIAL NOT NULL, "name" character varying(256) NOT NULL, "description" character varying NOT NULL, "location" character varying NOT NULL, "start_time" TIMESTAMP WITH TIME ZONE NOT NULL, "end_time" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "calendar_id" integer, CONSTRAINT "PK_40731c7151fe4be3116e45ddf73" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "events" ADD CONSTRAINT "FK_ace1de2cd4bea61dc1e8bbaf5cf" FOREIGN KEY ("calendar_id") REFERENCES "calendars"("id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "events" DROP CONSTRAINT "FK_ace1de2cd4bea61dc1e8bbaf5cf"`);
