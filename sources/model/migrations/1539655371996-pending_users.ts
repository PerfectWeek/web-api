...
export class pendingUsers1539655371996 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "pending_users" ("id" SERIAL NOT NULL, "pseudo" character varying(31) NOT NULL, "email" character varying NOT NULL, "ciphered_password" character varying NOT NULL, "validationUuid" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "PK_4dcd5954b4aecb4d483a5c7e7d8" PRIMARY KEY ("id"))`);
